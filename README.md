...
```math
\ce{$\unicode[goombafont; color:red; pointer-events: none; z-index: -1; position: fixed; inset: 0; block-size: 100dvb; inline-size: 100dvi; object-fit: cover; opacity: 50%; background-size: cover; background-image: url('https://benjaminaster.com/home/assets/salzburg_winter_nacht.webp');]{x0000}$}
```
